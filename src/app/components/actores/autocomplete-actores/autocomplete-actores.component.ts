...
export class AutocompleteActoresComponent implements OnInit {
  ...
  actores = [
    ...
    {nombre: 'Samuel L. Jackson', personaje: '', foto: 'https://m.media-amazon.com/images/M/MV5BMTQ1NTQwMTYxNl5BMl5BanBnXkFtZTYwMjA1MzY1._V1_UX214_CR0,0,214,317_AL_.jpgi'}
  ];
